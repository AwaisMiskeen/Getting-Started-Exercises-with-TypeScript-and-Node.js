...
let guest_List = ["Asad" , "Daniyal" , "Tariq" , "Awais"];
...
while(guest_List.length > 2) {
    ...
    console.log(`Sorry, ${remove_guest} some reason i remove you to guest list. `)
}

//print message to guest_list
console.log("Invitation to last Two Guest");
guest_List.forEach(guest_remain => console.log(`Luckly ${guest_remain}, You are still invite to dinner.`)); 
